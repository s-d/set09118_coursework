...
\begin{document}
	...
	\section*{Abstract}	
		This document is the final report and a summary to the "USB/Bluetooth Media Controller" project started in February [Appendix \ref{IPP}] [Appendix \ref{Interim}]. The goal of the project was to research, develop and evaluate a micro-controller based system and mobile application. \cite{ArduinoGit:online}
	...
	\section{Introduction}
		...
		\subsection{Aims and Deliverables}
			...
			\paragraph{Media Controller}
				...
				Media controllers come in a wide variety of designs, consisting of rows of buttons, sliders, rotary-knobs and switches. For the purposes of this project, the media controller produced will be a bare-bones, bread-board prototype.
