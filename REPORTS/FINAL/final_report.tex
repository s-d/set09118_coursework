...
\begin{document}
	...
	\section{Design}
		\subsection{Media-controller Design}
			...
			\begin{figure}[]
				...
				\caption{A circuit diagram of the finished media-controller}
			\end{figure}
	...
	\section{Implementation}
		\subsection{Media-controller Implementation}
			...
			While the majority of the hex codes presented in the Blog's table were usable, a few were depreicated and would not work. In order to get the 
