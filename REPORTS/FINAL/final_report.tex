	...
	\section{Introduction}
		...
		\subsection{Aims and Deliverables}
			...
			\paragraph{Mobile Application}
				...
				The goal of the applications appearance was to keep it as minimal as possible. The reason for this was to ensure the application's design was appealing and keep it as easy-to-use as possible.
